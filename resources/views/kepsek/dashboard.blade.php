...
@section('menu')
    <li class="active"><a><i class="fa fa-home"></i>&nbsp;Dashboard <span class="sr-only">(current)</span></a></li>
@endsection
@push('styles')
    <style>
        .loader {
...
@section('content')
    <div class="callout callout-info">
        ...
        <p>
            Anda Login Sebagai <b>Kepala Sekolah (KEPSEK)</b> Pada Sistem Pelaporan Kegiatan Harian Tendik Oleh Pimpinan Madrasah Islam Negeri Insan Cendikia (MAN IC) Bengkulu Tengah
            <br>
    ...
    <div class="box box-default">
        ...
        <div class="box-body">
            <form action="{{ route('kepala_sekolah.update') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="pegNama" class="form-control pegNama" id="pegNama">
                    ...
                    <div id="kegInput" >
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea name="komenTu" id="komenTu" class="form-control" readonly cols="30" rows="10">
                                @if (isset($_POST['kegId']))
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea name="komenKepsek" id="komenKepsek" class="form-control" cols="30" rows="10">
                                @if (isset($_POST['kegId']))
            ...
            $(document).on('change','#pegNama',function(){
                ...
                data: {'pegNama':pegNama,'_token':$('meta[name="csrf-token"]').attr('content')},
                    success:function(data){
                        // alert('ketemu');
                        // alert(data['data']['id']);
                        $(':input[name="komenKepsek"]').prop('disabled', false)
                        $('#nip').val(data['karyawan']['pegNip']);
                        $('#jabatan').val(data['karyawan']['pegNmJabatan']);
                        $('#tanggal').val(data['today']);
                        CKEDITOR.instances['komenKepsek'].setReadOnly(false);
                        if (data['detail'] == null) {
                            $('#warning').show(300);
                            $('#success').hide(300);
                            $('#kegInput').hide(300);
