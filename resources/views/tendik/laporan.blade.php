...
<body>
    <table id="header" cellspacing="0" cellpadding="0" style="width:100%;border: none !important;border-collapse: collapse;" class="top">
        <tr >
            <td rowspan="5" style="width: 5% !important;" class="logo-koperasi"><img src="{{ public_path('assets/images/logo.png') }}" style="width: 100px !important"></td>
  ...
  border-bottom: 1px solid #ddd !important;">No</th>
                <th style="padding: 8px !important;
  text-align: left !important;
  border-bottom: 1px solid #ddd !important;">Hari / Tanggal</th>
                <th style="padding: 8px !important;
  text-align: left !important;
  border-bottom: 1px solid #ddd !important;">Kegiatan Tendik</th>
                <th style="padding: 8px !important;
  text-align: left !important;
  border-bottom: 1px solid #ddd !important;">Catatan Kepala Tata Usaha</th>
                <th style="padding: 8px !important;
  text-align: left !important;
  border-bottom: 1px solid #ddd !important;">Catatan Kepala Madrasah</th>
            </tr>
        </thead>
        <tbody>
            @php
  ...
  text-align: left !important;
  border-bottom: 1px solid #ddd !important;">{{ $no++ }}</td>
                    <td style="padding: 8px !important;
  text-align: left !important;
  border-bottom: 1px solid #ddd !important;">{{ $laporan->kegTgl }}</td>    
                    <td style="padding: 8px !important;
  text-align: left !important;
  border-bottom: 1px solid #ddd !important;">{!! $laporan->kegTendik !!}</td>    
                    <td style="padding: 8px !important;
  text-align: left !important;
  border-bottom: 1px solid #ddd !important;">{!! $laporan->kegSaranKatu !!}</td>    
                    <td style="padding: 8px !important;
  text-align: left !important;
  border-bottom: 1px solid #ddd !important;">{!! $laporan->kegSaranKepsek !!}</td>    
                </tr>
            @endforeach
        </tbody>
    </table>
